...
export default function Hero() {
  return (
    <section className="mx-4 grid-cols-12 grid-rows-none text-white lg:mx-5 lg:grid lg:gap-x-5">
      <div className="header col-span-10 col-start-2 flex items-center justify-center leading-none lg:justify-between">
        <h1 className="tracking-sans-wide text-hero-lg hidden lg:block">
          Begin your Linux journey.
        </h1>
        <h1 className="text-highlight font-spencer text-hero-lg-serif text-heading-h3 leading-tighter">
          Linux-Lab
        </h1>
      </div>
      <div className="card__container shadow-highlight/20 relative col-span-10 col-start-2 row-start-2 h-[80lvh] max-h-full max-w-full overflow-clip rounded-sm shadow-[0_0_180px] lg:h-[65vh]">
        <img
          className="absolute top-0 left-0 z-0 h-full w-full object-cover select-none"
          src="media/blackholestatic.png"
          alt="black hole monochrome"
        />
        {/* background darken imgae*/}
        <div className="absolute z-0 h-full w-full bg-black/70"></div>
        <div className="relative z-20 mx-0 flex h-full w-full flex-col justify-between px-4 py-14 sm:mx-auto sm:max-w-lg md:max-w-xl lg:max-w-full lg:items-end lg:justify-end lg:px-14">
          ...
          <div className="bottom__cta flex flex-col gap-4">
            ...
            <div className="flex w-full items-center justify-center gap-4 rounded-sm p-4 lg:w-lg lg:bg-black/90 lg:backdrop-blur-xl">
